                            ...
                            <div class="row">
                                <div class="col-lg-5 col-sm-7">
                                    <div class="top_left_cont zoomIn wow animated">
                                        {!! $page->text !!}
                                        <a href="{{route('pages.show',['page' => $page->alias])}}" class="read_more2">Read
                                            more</a></div>
                                </div>
                ...
                <div class="inner_wrapper">
                    <div class="container">
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div
                                    class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">{!! Html::image('assets/img/'.$page->images,'',['class' =>'img-circle delay-03s animated wow zoomIn']) !!}</div>
                                <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                    <div class=" delay-01s animated fadeInDown wow animated">
                                        {!! $page->text!!}
                                    </div>
                                    <div class="work_bottom"><span>Want to know more..</span> <a
                                            href="{{route('pages.show',['page' => $page->alias])}}" class="contact_btn">Contact
                                            Us</a></div>
                                </div>
                            </div>
                        </div>
                ...
                @foreach($portfolios as $portfolio)
                    <!-- Portfolio Item -->
                        <div
                            ...
                            <div
                                class="portfolio_img">{{Html::image('assets/img/'.$portfolio->images,$portfolio->name)}} </div>
        ...
        <div class="container">
            ...
            <div class="team_section clearfix">
                @foreach($peoples as $k=>$people)
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{($k*2+3)}}s">
                        ...
                        <h3 class="wow fadeInDown delay-0{{($k*2+3)}}s">{{$people->name}}</h3>
                        <span class="wow fadeInDown delay-0{{($k*2+3)}}s">{{$people->position}}</span>
                        <p class="wow fadeInDown delay-0{{($k*2+3)}}s">{{$people->text}}</p>
                    </div>
                @endforeach
            </div>
        </div>
...
<footer class="footer_wrapper" id="contact">
                    ...
                    <div class="form">
                        <form action="{{route('pages.store')}}" method="POST">
                            ...
                            <input class="input-text" type="text" name="email" value="Your E-mail *"
                                   onFocus="if(this.value==this.defaultValue)this.value='';"
                                   onBlur="if(this.value=='')this.value=this.defaultValue;">
                            <textarea class="input-text text-area" cols="0" rows="0" name="text"
                                      onFocus="if(this.value==this.defaultValue)this.value='';"
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © {{date('Y')}},    Template by <a href="http://webthemez.com">WebThemez.com</a>. </span>
        </div>
    </div>
</footer>
